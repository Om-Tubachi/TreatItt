...
import IconChart from '../assets/TabIcons/Sell.svg';
...
const ICONS: Record<string, (size: number, color: string) => React.ReactNode> = {
  index: (s, c) => <IconHome width={s} height={s} fill={c} stroke={c} />,
  discover: (s, c) => <LocationPin width={s} height={s} fill={c} stroke={c} />,
  chart: (s, c) => <IconChart width={s} height={s} fill={c} stroke={c} />,
  recycle: (s, c) => <IconRecycle width={s} height={s} fill={c} stroke={c} />,
  marketplace: (s, c) => <IconMarketplace width={s} height={s} fill={c} stroke={c} />,
};
